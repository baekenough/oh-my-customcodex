...
- **dbt-core**: 1.11.8 (includes Fusion engine for faster parallel model execution)
- Fusion engine is enabled by default in dbt-core 1.11.x — no configuration required
