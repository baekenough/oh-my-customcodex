...
The runtime's `EnterWorktree` / `ExitWorktree` tools provide built-in worktree support for subagents. The aliases above complement this for manual or hook-driven workflows.
...
- Runtime `EnterWorktree` / `ExitWorktree` — Built-in tool support
