...
| 기능 | 설명 | 위치 |
|------|------|------|
| Skills | Markdown에 정의된 특화된 기능 | `.codex/skills/SKILL.md` |
| Slash commands | 일반적인 작업을 위한 사용자 정의 명령 surface | `.codex/skills/*/SKILL.md` |
| Memory | 프로젝트 컨텍스트 및 지침 | `AGENTS.md` 또는 `.codex/` runtime surface |
