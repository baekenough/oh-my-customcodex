...
updated: 2026-04-12
sources:
  - .codex/skills/omcustomcodex-release-notes/SKILL.md
related:
  - [[mgr-gitnerd]]
  - [[release-plan]]
  - [[deep-verify]]
...
- **Scope**: harness
- **User-invocable**: yes
- **Command**: `/omcustomcodex-release-notes`
...
- `.codex/skills/omcustomcodex-release-notes/SKILL.md` — skill definition
