...
## Claude v2.1.198-v2.1.199 and Fable 5 Updates

R006 now records Fable 5 as a Claude-template alias with high default effort, no redundant `[1m]` suffix, and Mythos 5 as limited availability / not GA. It also records Claude Code v2.1.198-v2.1.199 compatibility notes for Explore model inheritance, extended-thinking inheritance, hook stderr visibility, and stacked slash-skill loading depth. Codex-native agents still follow OMX role/model routing.

## Sources

- `.codex/rules/MUST-agent-design.md` — rule definition (v2.1.172 `availableModels` subagent-override note + v2.1.173 Fable 5 `[1m]` auto-normalization note added 2026-06-11)
