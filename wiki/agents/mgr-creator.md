...
- **Explicit mode** (`/omcodex:create-agent`): Follows a full research-driven 3-phase workflow (Research → Create → Auto-discover)
...
- **Used by**: R010 (Protected Paths rule), routing skills (dynamic fallback), `/omcodex:create-agent` command
