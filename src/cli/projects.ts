/**
 * omcodex projects command
 * Lists all projects on the machine where oh-my-customcodex is installed,
...
/**
 * Information about a project where oh-my-customcodex is installed
 */
...
function formatProjectsSimple(projects: ProjectInfo[], currentVersion: string): void {
  console.log(`\noh-my-customcodex 적용 프로젝트 (${projects.length}개):`);
  for (const project of projects) {
...
export async function projectsCommand(options: ProjectsOptions = {}): Promise<ProjectsResult> {
  ...
  console.log('  oh-my-customcodex 적용 프로젝트를 검색 중...');
