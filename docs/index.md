...
hero:
  ...
  text: GPT Codex + OMX native child package of oh-my-customcode
  tagline: Transform your coding workflow with a pre-configured agent harness, skills, and rules designed for Codex + OMX.
  actions:
    - theme: brand
      text: Get Started
    ...
    - theme: alt
      text: View on GitHub
      link: https://github.com/baekenough/oh-my-customcodex

features:
  - icon: "🤖"
    title: 48 Pre-built Agents
  ...
  - icon: "🎨"
    ...
    details: Create, modify, and extend agents, skills, and rules. The system is designed to grow with your needs.
  - icon: "🌐"
    title: Multi-language Support
    details: English and Korean language support out of the box. Initialize with your preferred language.
  - icon: "🔧"
    title: Health Checks
    details: Built-in doctor command to verify installation and auto-fix common issues.
---
...
| Manager Agents | 6 | creator, updater, supplier, gitnerd, sauron, claude-code-bible |
...
| Infra Agents | 2 | docker-expert, aws-expert |
| QA Agents | 3 | qa-planner, qa-writer, qa-engineer |

## Why oh-my-customcodex?

Codex + OMX is powerful, but setting up an effective agent system takes time. oh-my-customcodex provides:
