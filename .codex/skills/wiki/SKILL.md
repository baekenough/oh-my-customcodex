...
- `.codex/agents/*.md` — all agent definitions
- `.codex/skills/*/SKILL.md` — all skill definitions
- `.codex/rules/*.md` — all rule files
...
- All source files: scan `.codex/agents/`, `.codex/skills/`, `.codex/rules/`, `guides/`
...
├── Missing pages (N): .codex/agents/new-agent.md has no wiki page
...
```
Orchestrator
├── [1] subagent: agents/ category (reads .codex/agents/*.md, writes wiki/agents/*.md)
├── [2] subagent: skills/ category (reads .codex/skills/*/SKILL.md, writes wiki/skills/*.md)
├── [3] subagent: rules/ category (reads .codex/rules/*.md, writes wiki/rules/*.md)
...
| update-docs | Complement: update-docs syncs AGENTS.md counts; wiki syncs knowledge content |
