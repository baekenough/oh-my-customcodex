...
- Metrics appear in stderr during GPT Codex + OMX session execution
...
- **Claude Inspector**: Debugging specific payload issues, measuring AGENTS.md token impact, verifying ecomode (R013) effectiveness, profiling sub-agent context inheritance
...
Claude Inspector is external to oh-my-customcodex and does not require any project configuration changes.
